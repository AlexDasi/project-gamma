<div id="home">
    <section class="categories">
        <ul>
            <li id="graphic" class="categories--items categories--items-graphic text-hover-fill-goes-right"><a class="main-text graphic" href="">GRAPHIC</a></li>
            ...
            <li onmouseover="hideui()" onmouseout="hideui()" class="categories--items categories--items-ui"><a class="main-text ui" href="">USER INTERFACE</a></li>
            <li onmouseover="hideweb()" class="categories--items categories--items-web"><a class="main-text web" href="">WEB</a></li>
        </ul>
