...
<body class="project-page">
    ...
    <header class="project-header">
        <div class="project-header__image"><img class="center" src="../../content/pictures/projects/clustag/clustag.jpg" alt="Clustag Project"></div>
        <h1 class="padding3 project-header__title title title--project title--black">Clustag</h1>
